...
<html>
    <head>
        ...
        <script src="../js/pageVilles.js" type="text/javascript"></script>
                ...
                <fieldset>
                    ...
                    <div class="row">
                        <div class="mb-3 mt-3 col">
                            ...
                            <input type="text" class="form-control" id="telephone" placeholder="Entrez votre numéro" name="telephone" pattern="/^[0-9]${10}/gm">
                        </div>
                        <div class="mb-3 mt-3 col">
                            <label for="mail" class="form-label">Courriel :</label>
                            <input type="mail" class="form-control" id="mail" placeholder="adresse mail courante" name="mail"  pattern="/^[a-zA-Z]+@([a-zA-Z]+.)+[a-zA-Z]{2-4}$/gm" title="xxxx@yyyy.zzz">
                        </div>
                        <div class="mb-3 mt-3 col">
                            <label for="mailPro" class="form-label">Courriel professionnel :</label>
                            <input type="mail" class="form-control" id="mailPro" placeholder="Exemple : jean.dupond@laposte.net" name="mailPro"  pattern="/^[a-zA-Z]+@([a-zA-Z]+.)+[a-zA-Z]{2-4}$/gm" title="xxxx@yyyy.zzz">
                        </div>
                    </div>
