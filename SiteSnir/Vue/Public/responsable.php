                ...
                <fieldset>
                    ...
                    <div class="mb-1 mt-3 col">
                        <label for="adresseIdentique" class="form-label">L'adresse est identique à la votre :
                            <input type="checkbox" id="adresseIdentique" name="mdpAlea" onclick="CheckBoxActive()">
                        </label>
                    </div> 
                    <div class="row">
                        <div class="mb-3 mt-3 col">
                    ...
                    <div class="row">
                        <div class="mb-3 mt-3 col">
                            ...
                            <input type="text" class="form-control" id="telephone" placeholder="Entrez le numéro" name="telephone" pattern="/^[0-9]${10}/gm">
                        </div>
                        <div class="mb-3 mt-3 col">
                            <label for="mail" class="form-label">Courriel :</label>
                            <input type="mail" class="form-control" id="mail" placeholder="adresse mail" name="mail" pattern="/^[a-zA-Z]+@([a-zA-Z]+.)+[a-zA-Z]{2-4}$/gm" title="xxxx@yyyy.zzz">
                        </div>
                    </div>
